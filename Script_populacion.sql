...
insert into Detalle (id_producto, id_pedido, precio, cantidad) values 
(21, 1, 14,1),
(14, 2, 8,1),
(25, 3, 10,1),
(22, 4, 19,1),
...
select id_pedido, id_producto, precio, cantidad from Detalle order by id_pedido;



select id_pedido, id_producto, precio*cantidad as total from Detalle order by id_pedido;

-- selects reportes:
-- productos compra
-- tiempo de entrega
-- costo total
-- productos por proveedor (por ubicacion y total)
-- pedidos en proceso
