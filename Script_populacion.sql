...
-- 30 productos
insert into Productos (serial, nombre, precio, tiempo_aliste, id_proveedor) values
...
-- 120 
insert into Detalles (id_producto, id_pedido, precio, cantidad, id_ubicacion) values 
(1, 1, 14, 9, 1),
(1, 2, 7, 14, 35),
(1, 3, 10, 13, 36),
(2, 4, 7, 9, 6),
